...
router.post(
  "/",
  authenticate,
  authorizePermission([Permission.CREATE_LOT]),
  uploadAnimalPhoto.single("photo"),
  validator(createLotSchema),
  createLot,
);
router.get(
  "/",
  authenticate,
  authorizePermission([Permission.READ_LOT]),
  getAllLots,
);
router.get(
  "/:id",
...
router.put(
  "/:id",
  authenticate,
  authorizePermission([Permission.UPDATE_LOT]),
  uploadAnimalPhoto.single("photo"),
  validator(updateLotSchema),
  updateLot,
);
router.delete(
  "/:id",
  authenticate,
  authorizePermission([Permission.DELETE_LOT]),
  deleteLot,
);
